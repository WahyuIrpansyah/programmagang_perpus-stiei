        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">PERPUSTAKAAN STIEI BANJARMASIN </h2>
        ...
        <div class=" row">
            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" datea-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="./lib/img/3.jpeg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="./lib/img/4.jpeg" class="d-block w-100" alt="...">
                    </div>
                </div>
            </div>
        </div>
