...
$pdf->AddPage();
$pdf->SetTitle("Laporan Data Pengembalian");
...
$pdf->Cell(0, 1, "Laporan Data Pengembalian", 0, 1, "C");
$pdf->Ln();
...
$pdf->Cell(4, 1, "Tanggal Kembali", 1, 0, "C", true);
$pdf->Cell(4, 1, "Denda", 1, 1, "C", true);
...
foreach ($kembali as $a) {
    ...
    $pdf->Cell(4, 1, $a->jurusan, 1, 0, "C");
    $pdf->Cell(4, 1, $a->id_buku, 1, 0, "C");
    $pdf->Cell(4, 1, $a->tanggal_pinjam, 1, 0, "C");
    $pdf->Cell(4, 1, $a->tanggal_kembali, 1, 0, "C");
    $pdf->Cell(4, 1, $a->denda, 1, 1, "C");
}

// Output
$pdf->Output("I", "Laporan Data Pengembalian.pdf");
