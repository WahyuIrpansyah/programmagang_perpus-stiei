...
$pdf->Cell(19, 1, "Laporan Data Pengunjung", 0, 1, "C");
$pdf->Ln();
...
$pdf->Cell(4, 1, "Jumlah Pengunjung", 1, 1, "C", true); // Perubahan di sini
$pdf->SetFont("Arial", "", 11);
$no = 1;
foreach ($pengunjung as $a) {
    ...
    $pdf->Cell(4, 1, $a->jumlah_pengunjung, 1, 1, "C"); // Perubahan di sini
}
